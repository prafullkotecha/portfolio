...
Hosting strategy for the 91-project portfolio. For the authoritative list of what is live today, see [DEPLOYMENTS.md](./DEPLOYMENTS.md).

## Current decision

GitHub Pages is the active host for the portfolio and 24 static projects. It was selected for the September 2026 deployment batch because GitHub authentication was available, the projects could be exported as static assets, and repository-scoped GitHub Actions provided repeatable deployments at no additional cost.
